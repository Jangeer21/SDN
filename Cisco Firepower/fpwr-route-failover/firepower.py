...
#baseurl = "https://" + FMC + "/api/fmc_config/v1/domain/{domainUUID}"
...
class FirePower():
    ...
    def authRequest(self):
        ...
        #authurl = "https://FMC/api/fmc_platform/v1/auth/generatetoken"
    ...
    def getGlobalVR(self):
        ...
        #vr_url = "/devices/devicerecords/{containerUUID}/routing/virtualrouters"
    ...
    def addRoute(self):
        ...
        if route:
            ...
            #add_url = "/devices​/devicerecords​/{containerUUID}​/routing​/virtualrouters​/" + \
            #          self.globalVR + "/ipv4staticroutes"
    ...
    def delRoute(self):
        ...
        if route is False:
            ...
            #del_url = "/devices​/devicerecords​/{containerUUID}​/routing​/virtualrouters​/" + \
            #          self.globalVR + "/ipv4staticroutes" + route['id']
    ...
    def deployPolicy(self):
        ...
        #url1 = "/deployment/deploymentrequests"
        #url2 = "/deployment/deployabledevices/{containerUUID}/deployments"
    ...
    def getFailoverInterface(self, failover_interface):
        ...
        #iface_url = "/devices/devicerecords/{containerUUID}/physicalinterfaces"
    ...
    def getRoutes(self):
        ...
        route_url = "/devices/default/routing/virtualrouters/" + \
                    self.globalVR + "/staticrouteentries"
        #route_url = "/devices​/devicerecords​/{containerUUID}​/routing​/virtualrouters​/" + \
        #            self.globalVR + "/ipv4staticroutes"
